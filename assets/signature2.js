...
SignaturePad2.prototype.toDataURL = function (type) {
	var _canvas;
	switch (type) {
	case 'image/svg+xml':
	return this._toSVG();
...
SignaturePad2.prototype._createPoint = function (x, y, time) {
...
SignaturePad2.prototype._calculateCurveWidths = function (curve) {
...
SignaturePad2.prototype._drawDot = function (point) {
	var ctx = this._ctx;
