...
function SignaturePad3(canvas, options) {
	var self = this;
	var opts = options || {};
...
SignaturePad3.prototype.toDataURL = function (type) {
	var _canvas;
	switch (type) {
	case 'image/svg+xml':
	return this._toSVG();
...
SignaturePad3.prototype._createPoint = function (x, y, time) {
...
SignaturePad3.prototype._calculateCurveWidths = function (curve) {
...
SignaturePad3.prototype._drawDot = function (point) {
	var ctx = this._ctx;
...
SignaturePad3.prototype._fromData = function (pointGroups, drawCurve, drawDot) {
...
SignaturePad3.prototype._toSVG = function () {
	var _this2 = this;
...
SignaturePad3.prototype.fromData = function (pointGroups) {
	var _this3 = this;
	this.clear();
	this._fromData(pointGroups, function (curve, widths) {
...
SignaturePad3.prototype.toData = function () {
	return this._data;
};
