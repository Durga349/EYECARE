...
?>
	...
	<div class="main-container h-100 ">
		<form method="POST" action="save_ocularsymptoms.php">
			...
			<div class="card">
				<div class="card-header text-center "><h3>Ocular Symptoms</h3></div>
					<div class="card-body">
						...
						<div class="row mt-3">
							<div class="col-md-12">
								<input type="reset" name="cancel" id="cancel" class="btn btn-danger" value="Back"  onclick="window(location='view_ocularSymptoms.php')">
								<input type="submit" name="submit" value="submit" class="btn btn-primary float-right" onclick="return validation()">
							</div>
						</div>
					</div>
