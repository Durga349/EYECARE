  ...
  <div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
      <div class="min-height-200px">
          ...
          <div class="row">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">OcularSymptoms</li>
                </ol>
              </nav>  
            </div>
          </div>
       ...
       <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#OcularSymptoms">
              ...
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                ...
                bnTd = `<div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="edit_view_OcularSymptoms.php?type=view&Id=${oData.columnId}"><i class="dw dw-eye"></i>View</a>
                        <a class="dropdown-item" href="edit_view_OcularSymptoms.php?type=edit&Id=${oData.columnId}"><i class="dw dw-edit2"></i>Edit</a>
...
function RemoveAccount(columnId) {
  ...
  if(check) {
    $.ajax({
      url  : "saveOcularSymptoms.php",
      type : "post",
      data : { columnId : columnId, 'action' : 'delete' },
