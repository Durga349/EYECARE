            ...
            <table class="data-table table stripe hover nowrap" width="100%" align="center" id="Form_Table">
              <thead>
                <tr>
                  ...
                  <th>Contact</th>
                  <th>Zip Code</th>
                  <th class="datatable-nosort">Details</th>
                </tr>
              </thead>
  ...
  <script type="text/javascript" >
    ...
    var table=$('#Form_Table').DataTable(
    {
        ...
        "columns": [
            ...
            { "data" : "id",
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                let bnTd = `<a href="ViewFamilyData.php?patient_no=${oData.patient_number}" title="Edit"><i class="fas fa-angle-double-right" aria-hidden="true"></i></a>&nbsp;&nbsp;`;
