...
$get_qry="SELECT * FROM generalhealth WHERE columnId ='".$getdata."'";
...
?>
	...
	<div class="row mt-3">
		<div class="col-md-12">
			<input type="reset" name="cancel" id="cancel" class="btn btn-danger" value="Back"  onclick="window(location='manage_generalHealth.php')" style="margin-left: 45%;">
		</div>
	</div>
	<?php } ?>
	<!-- ----------------------------------Edit-------------------------------	 -->
	...
	<div class="row mt-3">
		<div class="col-md-12">
			...
			<input type="hidden" name="hid_ID" value="<?php echo $get_GEN_HEL[0]['columnId'] ?>" id="hid_ID">

			<input type="reset" name="cancel" id="cancel" class="btn btn-danger" value="Back"  onclick="window(location='manage_generalHealth.php')">
		</div>
	</div>
        ...
        $.ajax({
          ...
          success: function (data) {
            if (data.trim() == 'true'){
              ...
              setTimeout(function (){
                location.href = "manage_generalHealth.php";
              },1000);
            }
            else{
