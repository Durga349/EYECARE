    ...
    <div class="pd-ltr-20 xs-pd-20-10">
      <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30" style="">
          <div class="clearfix">
            <div class="pull-left">
              <h4 class="text-blue h4">Add Visitor</h4><br>
          ...
          <form name="addformpage" id="addformpage"  autocomplete="off" method="post" enctype="multipart/form-data">
              ...
              <!-- <select name="document_no" id="document_no" class="form-control">
                    <option value="">Choose Document No.</option>
                    <?php foreach($dropdowns_data as $value){ ?>  
                     <option value="<?php echo $value['id']?>"><?php echo $value['document_no']?></option>
                     <?php }?>                  
                  </select> -->

                  <input type="text" name="document_no" id="document_no" class="form-control" readonly>
                </div>
