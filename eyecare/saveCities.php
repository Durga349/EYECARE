...
$crud = new Crud();
 ...
 $hdn_id    = isset($_POST['hdn_id']) ? $_POST['hdn_id'] : ''; 
   ...
   if (isset($_POST['action']) && $_POST['action'] == 'save'){   
       ...
       $ins_sql = "insert into ".$tableName." set state_id ='".$state_name."',city_name='".$city_name."',random_id='".$random_id."'";
     //exit;  
        $city_data = $crud->execute($ins_sql);
        if ($city_data) {
         echo "true";
        }else{
          echo "false";
...
if (isset($_POST['action']) && $_POST['action'] == 'update'){  
  ...
  // exit;
    ...
    $roleupdate = "update ".$tableName." set state_id ='".$state_name."', city_name='".$city_name."' where id ='".$_POST['hdn_id']."'";
//exit;
