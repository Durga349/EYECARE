    ...
    var table=$('#Form_Table').DataTable(
    {
        ...
        "columns": [
            ...
            { "data" : "vehi_photo",
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                  $(nTd).html(`<img width="100%" height="100px" src="${oData.vehi_photo}"/>`);
                } 
              },            
            { "data" : "id",
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
              ...
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                ...
                bnTd = `<div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="editforGoods.php?type=view&randomId=${oData.randomId}"><i class="dw dw-eye"></i> View</a>
                        <a class="dropdown-item" href="editforGoods.php?type=edit&randomId=${oData.randomId}"><i class="dw dw-edit2"></i> Edit</a>
...
function RemoveAccount(id) {
  ...
  if(check) {
    $.ajax({
      url  : "actions.php",
      type : "post",
      data : { id : id, 'action' : 'delete_for_Goods' },
...
//       url  : "actions.php",
//       type : "post",
//       data : { id:id, 'action' : 'forgoods_statusyes','status':status },
//       success: function(data) {
//         if(data == 'true') {
