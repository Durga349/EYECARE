              ...
              fnCreatedCell: function (nTd, sData, oData, iRow, iCol) {
                ...
                bnTd = `<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="editDropdown.php?type=view&randomId=${oData.randomId}"><i class="dw dw-eye"></i> View</a>
												<a class="dropdown-item" href="editDropdown.php?type=edit&randomId=${oData.randomId}"><i class="dw dw-edit2"></i> Edit</a>
