...
$crud = new Crud();
             ...
             ////////// for patient number  /////////
         $sm1 ="select MAX(ID) as mxid FROM patient_master_table";
        
        $slm_data1 = $crud->getData($sm1); 
         
         if($slm_data1 ==''){
            $mid = '1';
        }else{
        
        $mid_pat = $slm_data1[0]['mxid']+1;
...
// print_r($resGeneralHealth);
    ...
    $qryGeneralHealth2="select * from ocularsymptoms where dispStatus=1  
   order by priority";
  $resGeneralHealth2=$crud->getData($qryGeneralHealth2);

    $qryFamilyHistory="select * from familyhistory where dispStatus=1   
   order by priority"; 
          ...
          <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
              <div class="panel-heading" role="tab" id="headingOne">
                ...
                <!--   </div>
                  <div class="col-md-6">
                  <input type="radio" name="status" id="yes" value="yes" onchange="jFyesNo(this.value)">&nbsp;Yes &nbsp;
                    <input type="radio" name="status" id="no" value="no" onchange="jFyesNo(this.value)">&nbsp;No
                  </div> 
                    </div>-->
             ...
             <!--    <div class="col-md-4 mt-4">
                     ...
                     <?php } ?>                      
                      ...
                      <div class="col-md-4 mt-4">
                          ...
                          <input type="text" name="patient_number" id="patient_number" class="form-control" placeholder="" value="<?php echo $pid_pat; ?>" readonly>                                  
                         
                      </div> 
                       <div class="col-md-4 mt-4">
                          <label><strong>Patient SSN No:</strong><span class="mand"></span></label>
                          <input type="text" name="patient_ssn" id="patient_ssn" class="form-control" placeholder="Enter Last Four Digits of SSN" maxlength="4">                                  
                         
                      </div> 
                        <div class="col-md-4 mt-4">
                    
                      <label ><strong>First Name:</strong><span class="mand">*</span></label>
                      <input type="text" class="form-control" id="patientFname" placeholder="" name="patientFname" title="enter First name" onkeyup="capitalizeFirstLetter(this)">
                      </div>
                    ...
                    <div class="row">
                      ...
                      <input type="text" class="form-control" id="plastLname" placeholder="" name="plasLtname" title="enter Last Name" onkeyup="capitalizeFirstLetter(this)">
                      </div>
                      <div class="col-md-4 mt-4">
                    ...
                    <span id="spnError" class="error" style="display: none">Please select a Fruit.</span>
                       ...
                       <label ><strong>DOB:</strong><span class="mand">*</span></label><br>
                        <input type="date" id="patDob"name="patDob" placeholder="" title="Enter the Date Of Brith" class="form-control">
             ...
             <div class="row mb-4">
              <div class="col-md-4 mt-4">
                      <label><strong>Home Phone:</strong><span class="mand"></span></label>
                          <input type="text" name="homeph" id="homeph"  class="form-control" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" oninput="this.value = !!this.value &amp;&amp; Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" maxlength="10">
                      </div>
                       <div class="col-md-4 mt-4">
                          <label><strong>Office No:</strong><span class="mand"></span></label>
                         <input type="text" name="workNo" id="workNo"  class="form-control" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" oninput="this.value = !!this.value &amp;&amp; Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" maxlength="10">
                      </div>
                       <div class="col-md-4 mt-4">
                          <label><strong>Mobile No:</strong><span class="mand">*</span></label>
                          <input type="text" name="cell" id="cell"  class="form-control" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" oninput="this.value = !!this.value &amp;&amp; Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" maxlength="10">
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4 mt-4">
                         ...
                         <input type="text" name="zipCode" id="zipCode"  class="form-control" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" oninput="this.value = !!this.value &amp;&amp; Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" maxlength="6">
                      </div>
                        <div class="col-md-4 mt-4">
                    ...
                    <div class="row" style="display:none;" id="show_data">
                       <div class="col-md-6 mt-4">
                          <label ><strong>Vision Insurance :</strong><span class="mand">*</span></label>
                          <input type="text" name="insurance" id="insurance" placeholder="" class="form-control">
                      </div> 
                        <div class="col-md-6 mt-4">
                      <label ><strong>Insurance Subscribers First Name:</strong><span class="mand">*</span></label>
                      <input type="text" class="form-control" id="insFname" placeholder="" name="insFname" title="enter First name" >
                      </div><br>
                     <div class="col-md-6" style="margin-top: 15px;">
                      <label ><strong>Insurance Subscribers Last Name:</strong><span class="mand">*</span></label>
                      ...
                      <div class="col-md-6" style="margin-top: 15px;">
                          <label><strong>Insurance Subscribers :</strong><span class="mand">*</span></label>
                                  ...
                                  <input type="radio" name="insSubscribers" id="member_id1" value="MemberId" onchange="JfSSNchanplc(this)" checked>&nbsp;Member Id&nbsp;
                                  <input type="radio" name="insSubscribers" id="ssn1" value="SSN" onchange="JfSSNchanplc(this)">&nbsp;SSN
                                  <input type="text" id="codeval" name="codeval" class="form-control col-md-8 pt-4" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" oninput="this.value = !!this.value &amp;&amp; Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" maxlength="4" placeholder="Please Enter Member Id" onblur="jfcheckSSN(this.value)"> 
                         
                      </div> <br>          
                        <div class="col-md-6" style="margin-top: 15px;">
                        <label ><strong>Insurance Subscribers DOB:</strong><span class="mand">*</span></label><br>
                        ...
                        <div class="row" style="display:none;" id="show_Group">
                           <div class="col-md-6">
                            <label><strong>Group on:</strong><span class="mand">*</span></label>
                       ...
                       <div class="row" style="display:none;" id="show_self">
                           <div class="col-md-6">
                            <label><strong>Self Pay:</strong><span class="mand">*</span></label>
               ...
               <div class="row">
                 <div class="col-md-12 mt-4">
                      ...
                      <input type="date" name="date_pat" id="date_pat" class="form-control">
                        ...
                        <p>I, <input type="text" name="represent_name" id="represent_name" style="border:none; border-bottom: 1px dashed;" ><br><br>
...
alcohol,<br> or other substances?  </label><br>
            <input type="radio" name="asecigarettes" id="asecigarettes1" value="yes" >&ensp;Yes
             <input type="radio" name="asecigarettes" id="asecigarettes2" value="no" >&ensp;No<br>
      ...
      <div class="row">
        ...
        <?php $i=1;foreach($resGeneralHealth as $key=>$value){ 
          $j=1;?>
            <tr>
              <td><input type="hidden" value="<?php echo $value['columnId'];?>" name="genHealth_Id<?php echo $i;?>" id="genHealth_Id<?php echo $i;?>" ><?php echo $i;?></td>
            ...
            <div class="row pt-4">
                <div class="col-md-6">
                  <label><b>Do You Currently Wear Contact Lenses:</b><span class="mand">*</span></label><br>
                ...
                <div class="col-md-6" style="display: none;" id="show_text">
                  ...
                  <input type="text" name="whatKind" id="whatKind" class="form-control" placeholder="">
                </div> 
            </div>
            <br>
            <div class="row pt-4">
                <div class="col-md-6">
                  ...
                  <input type="text" name="solutionUsed" id="solutionUsed" class="form-control" placeholder="">
                </div>
            ...
            <div class="col-md-6">
                  ...
                  <input type="radio" name="satisfied_vision" id="areYousatiesfiedWithTheVision3" value="not_applicable">&nbsp;Not Applicable&nbsp;<br>
            ...
            <div class="row pt-4">
                <div class="col-md-6">
                  <label><b>Would You Prefer Clear, Or Colored Contact Lenses?</b></label><br>
                ...
                <input type="radio" name="doyouUseTheComputer" id="doyouUseTheComputer1" value="Yes" onclick="show_hours(this.value)">&nbsp;Yes&nbsp;
                  <input type="radio" name="doyouUseTheComputer" id="doyouUseTheComputer2" value="No" onclick="show_hours(this.value)">&nbsp;No&nbsp;<br>
                  <label id="doyouUseTheComputer-error" class="error" for="doyouUseTheComputer" style="display: none;">Please Enter The Field</label>
                </div>
            </div>
            <br>
               <div class="row pt-4"> 
        ...
        <?php echo $value['displayFieldName'];?></td>
              <td>
               ...
               <!--  <input type="checkbox" id="ocularsymptoms<?php echo $i;?>" name="ocularsymptoms[]" value="0" class="form-check-inline" onchange="ocularcheck(this)"> -->
              </td>
            </tr>
        <?php $i++;$j++;} ?>
    ...
    <p align="justify">We look forward to providing all your vision care needs, and will go  above and beyond  to  provi de excellent customer service. Please take a moment to review our policies. </p>
      <ol>
        ...
        <li>All frames placed on hold will be returned back to the display case for sale after <u>two weeks</u>.</li><br>
          ...
          <input type="checkbox" name="agree_tc[]" id ="agree_tc1" value="agree_tc1" >&ensp; I authorize and request my insurance company to pay to the eye doctor benefits otherwise payable to 
          ...
          <input type="checkbox" name="agree_tc[]" id="agree_tc2" value="agree_tc2" >&ensp; I agree to all of the policies and services above. 
          <br><br>
          ...
          <div class="col-md-6">
            ...
            <!-- <input type="submit" name="submit" id="eye_id" value="Save" class="btn btn-primary" data-action="save-png"><span class="glyphicon glyphicon-ok" style="float:right;background-color:#0BA1C2;border-color:#0BA1C2;"></span> Save as PNG -->
            ...
            <input type="reset" name="cancel" value="Back" class="btn btn-danger" onclick="window(location='index.php')" style="float:left;">  
          </div>
...
//        ocupation          : "required",
    ...
    messages: {         
        ...
        patient_number    : "Please Enter Patient Number",
       ...
       selfcode           : "Please Enter SelfCode",
...
function jfcheckSSN(V){
 // alert(V);
      $.ajax({
            url : 'showData.php',
            type : 'POST',
            data: {V : V, 'action' : 'checkSSN'},
            success : function(data){
                if (data == "true"){
                     // alert('SSN Number is already exist');
                    toastr.error("SSN Number already exist");
                      $("#codeval").val('');
                }
